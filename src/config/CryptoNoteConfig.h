...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 120; // M
        ...
        const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX                 = 620000;  //v3
        const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V2              = 700000;  //v4
        const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V3              = 800000;  //v5
        ...
        /* The mixin to use by default with zedwallet and mangocoin-service */
        ...
        const uint64_t MAX_OUTPUT_SIZE_NODE   = 5'000'000'000'00000000;
        ...
        /* The index in the FORK_HEIGHTS array that this version of the software will
           ...
           software will support the fork at 300,000 blocks. (300,000-500,000 supported)
    ...
    const uint64_t DATABASE_READ_BUFFER_MB_DEFAULT_SIZE          = 10;           // Recommended - 1 GB
    const uint32_t DATABASE_DEFAULT_MAX_OPEN_FILES               = 100;           // Recommended - 500 files
    const uint16_t DATABASE_DEFAULT_BACKGROUND_THREADS_COUNT     = 2;             // Recommended - 10 DB Threads
    ...
    /* MainNet Network Identifier for Mangocoin */
