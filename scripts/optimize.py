# USAGE: Start mangocoin-service as you usually would
...
from mangocoincoin import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="Mangocoin address to optimize", required=True)
